    ...
    try:
        ...
        try:
            ...
            cur.execute("""
                ...
                VALUES ('Dra Ana 2', %s, %s, 'Medico', TRUE)
            """, (email, senha))
            ...
            cur.execute("""
                ...
                VALUES 
                ('Dra Ana 2', %s, 'Psicólogo', 'USF Centro', TRUE, TRUE, 'Ativo', '12121212121', '81121212121', '1985-05-15', 'FUNCANA2')
                RETURNING id
            """, (email,))
            func_id = cur.fetchone()[0]
            
            # Vinculo Especialidade (Se 'Psicólogo' der erro, tento sem acento tb)
            ...
            conn.commit()
            print("\nSUCESSO: Usuario 'ana.souza2@qualisus.com' senha '123' criado.\n")
